 ...
 * @property {Number} surcharge optional
 */
const ShippingOverride = new SimpleSchema({
  "state": {
    type: String,
    optional: true
  },
 ...
 * @property {ShippingOverride[]} shippingOverride optional
 * @property {ImageSizes[]} imageURLs optional
 */
 ...
 * @memberof Schemas
 * @type {SimpleSchema}
 * @property {String} discountId optional
 * @property {String} code optional
 */

const DataObj = new SimpleSchema({
  "discountId": {
    type: String,
    optional: true
  },
 ...
 * @type {SimpleSchema}
 * @property {String} _id
 * @property {String} amount optional
 * @property {Date} createdAt optional
 * @property {String} currencyCode optional
 * @property {DataObj} data optional
 * @property {String} displayName optional
 * @property {String} method optional
 * @property {String} mode optional
 * @property {String} name optional
 * @property {String} paymentPluginName optional
 * @property {String} processor optional
 * @property {String} shopId optional
 * @property {String} status optional
 * @property {String} transactionId optional
 */

const BillingObj = new SimpleSchema({
  "_id": {
    type: String,
  },
  "amount": {
 ...
 * @property {BillingObj[]} billing Array of BillingObj optional
