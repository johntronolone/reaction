...
export default async function buildOrderItem(context, { currencyCode, inputItem }) {
  ...
  const newItem = {
    ...
    shippingOverride: chosenProduct.shippingOverride,
    imageURLs: ((chosenVariant.primaryImage && chosenVariant.primaryImage.URLs)? chosenVariant.primaryImage.URLs : chosenProduct.primaryImage.URLs),
