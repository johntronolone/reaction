...
export default async function updateOrderFulfillmentGroup(context, input) {
  ...
  //console.log({status});
  //console.log({orderFulfillmentGroup});
  //console.log(orderFulfillmentGroup.workflow);
  //console.log(orderFulfillmentGroup.workflow.workflow);
  //console.log(orderFulfillmentGroup.workflow.status);
